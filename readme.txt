...
Write up a short report about Python (HW2-1), the graphical method (HW2-2) and the derivation of the Shadow Price (HW2-3) and discuss what you have learned. Zip your report, the graphs for HW2-2, and the Script Files (USD2NTD.py, graphical.py, and ShadowPrices.py) into one .zip file.
...
Homework 3-1
Script Files for:
-printing of integers from 1 to 50 divisible by 11 using a for loop.
-printing of integers from 1 to 30 divisible by 5 or 7 using a for loop.
-printing of integers from 1 to 30 divisible by 2 and 7 using a for loop.
-printing of integers from 1 to 20 not divisible by 2 nor 7 using a while loop.
-printing of odd integers from 1 to 20 using a while loop.
...
Homework11
In this homework, you are to implement the column generation with
...
Please submit the compressed .zip file which includes your .py, and .pdf
report on you findings of column generation.
...
Answer:
x12 = x23 = x31 = 1.
What if we do not use binary decision variables, but

continuous variables with upper bounds?
Homework12-2
Solve the Transportation Problem using Gurobi and
confirm that the solution from the Transportation
Algorithm introduced in this lecture is correct.
Does it make a difference whether the decision variables
